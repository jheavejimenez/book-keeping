...
function Sidebar () {
    return (
        <>
            {/* Dashboard */}
            <div
                className={"fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-blue-400 " + 
                    ...
                    <ul className="flex flex-col py-4 space-y-1">
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="ml-2 text-sm font-medium tracking-wide truncate">Profile</span>
                            </a>
                        </li>
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="ml-2 text-sm font-medium tracking-wide truncate">Settings</span>
                            </a>
                        </li>
                    </ul>
