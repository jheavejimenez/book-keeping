            ...
            >
                <div className={"overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow"}>
                    <ul className="flex flex-col py-4 space-y-1">
                        ...
                        <li>
                            <a href="#"
                                className={"relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 " + 
                                "dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent " + 
                                "hover:border-blue-500 dark:hover:border-gray-800 pr-6"}
                            >
                            ...
                            >
                                <span className="inline-flex justify-center items-center ml-4">
                                    ...
                                    <span
                                        ...
                                        "tracking-wide text-blue-500 bg-indigo-50 rounded-full"}
                                    >New</span>
                            </a>
                        </li>
