...
export default function ButtonSendfle() {
    const [showModal, setShowModal] = React.useState(false);
    return (
        <>
            {/*Button send file in Outgoing*/}
            <button
                className="text-blue-500 bg-white active:bg-blue font-bold uppercase text-sm px-6 py-3 rounded shadow hover:bg-blue-100 shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                type="button"
