                     ...
                     "fixed inset-0 z-50 outline-none focus:outline-none shadow-lg"}>
                        <div className="container mx-auto w-11/12 md:w-2/3 max-w-md">
                            ...
                            <div className="relative py-6 px-6 md:px-6 bg-white shadow-md rounded border border-gray-400">
                                {/*header*/}
                                <div className="flex items-start justify-between pb-3 border-b border-solid border-slate-200 rounded-t-md">
                                ...
                                {/*footer*/}
                                <div className="flex items-center justify-end pt-6 border-t border-solid border-slate-200 rounded-b-md">
                                    <button
