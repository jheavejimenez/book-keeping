...
function ClientIncomingTableRow({DocID, Sender, File, DateReceived}) {
    ...
    return (
        <tr className={" hover:bg-gray-300 text-black "}>
            ...
            <td className={" flex justify-center items-center w-14 h-14 transition-all " +
...
export default ClientIncomingTableRow;